class Project {
  ...
  double get budgetProgress => budgetTotal > 0 ? (budgetDepense / budgetTotal).clamp(0.0, 1.0) : 0.0;
...
final List<Project> sampleProjects = [
  Project(
    id: '1', clientId: 'c1',
    titre: 'Villa Carthage', description: 'Construction villa R+1 avec piscine',
  ...
  Project(
    id: '2', clientId: 'c2',
    titre: 'Résidence Les Pins', description: 'Immeuble R+4, 16 appartements',
