...
class _RegisterScreenState extends State<RegisterScreen>
  ...
  void dispose() {
    _anim.dispose();
    for (final c in [_nomCtrl, _prenomCtrl, _emailCtrl, _passwordCtrl,
                     _confirmCtrl, _telCtrl, _cabinetCtrl]) {
      c.dispose();
    }
    super.dispose();
  }
          ...
          Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const Text(
                ...
                style: TextStyle(fontSize: 14, color: Color(0xFF94A3B8), height: 1.7),
              ),
    ...
    child: SingleChildScrollView(child: Column(children: [
      Container(
        ...
        child: const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          _Logo(dark: true),
          SizedBox(height: 20),
          Text('Créez votre espace de travail.',
  ...
  List<Widget> get _featureItems => [
    const _FeatureItem(icon: LucideIcons.shieldCheck, text: 'Données isolées par architecte'),
    const SizedBox(height: 16),
    const _FeatureItem(icon: LucideIcons.users,       text: 'Gérez votre équipe et clients'),
    const SizedBox(height: 16),
    const _FeatureItem(icon: LucideIcons.barChart2,   text: 'Suivi financier en temps réel'),
  ];
    ...
    child: SlideTransition(
      ...
      child: Form(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const Text('Remplissez les informations pour démarrer',
          ...
          _TwoColumnRow(
            left:  _AuthField(label: 'Prénom *', controller: _prenomCtrl,
                prefixIcon: LucideIcons.user,
                validator: (v) => (v == null || v.trim().isEmpty) ? 'Requis' : null),
            right: _AuthField(label: 'Nom *', controller: _nomCtrl,
                prefixIcon: LucideIcons.user,
                validator: (v) => (v == null || v.trim().isEmpty) ? 'Requis' : null),
          ),
          const SizedBox(height: 16),
          _AuthField(
            label: 'Adresse e-mail *', controller: _emailCtrl,
          ...
          const SizedBox(height: 12),
          _TwoColumnRow(
            left:  _AuthField(label: 'Nom du cabinet', controller: _cabinetCtrl,
                prefixIcon: LucideIcons.building2),
            right: _AuthField(label: 'Téléphone', controller: _telCtrl,
                keyboardType: TextInputType.phone, prefixIcon: LucideIcons.phone),
          ),
          const SizedBox(height: 24),
          ...
          _AuthField(
            ...
            obscureText: _obscurePass, prefixIcon: LucideIcons.lock,
          ...
          _AuthField(
            ...
            obscureText: _obscureConfirm, prefixIcon: LucideIcons.lock,
            suffixIcon: _obscureConfirm ? LucideIcons.eyeOff : LucideIcons.eye,
          ...
          ValueListenableBuilder(
            ...
            builder: (_, __, ___) => _PasswordStrength(password: _passwordCtrl.text),
          ),
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text('Force : ${_label(s)}',
            style: TextStyle(fontSize: 11, color: _color(s), fontWeight: FontWeight.w500)),
      ]),
    );
  }
}
...
class _AuthField extends StatelessWidget {
  ...
  OutlineInputBorder _border(Color c, {double width = 1.0}) => OutlineInputBorder(
    borderRadius: BorderRadius.circular(10), borderSide: BorderSide(color: c, width: width));
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: [
      Text(label, style: const TextStyle(
          fontSize: 12, fontWeight: FontWeight.w500, color: kTextMain)),
      const SizedBox(height: 6),
      TextFormField(
...
class _Logo extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(children: [
    ...
    Text('ArchiManager', style: TextStyle(
